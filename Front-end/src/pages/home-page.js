            ...
            jd.div({className:"flex flex-col absolute z-10 top-48 gap-4"},[
                ...
                jd.div({
                    ref: el => {
                        effect(el, () => {
                            if (PackageData()) {
                                el.replaceChildren(jd.div({className: "flex flex-col w-full bg-white p-2"},[
                                    jd.div({className: "flex flex-row relative justify-around mb-10 mt-5"},[
                                    ...
                                    jd.div({className: "flex flex-row w-full justify-between"},[
                                        jd.div({className: "flex flex-col h-full"},[
                                            jd.div({className: "flex flex-col border-b"},[
                                ...
                                el.replaceChildren(jd.div({className: "flex h-20 w-full bg-white"},[
